<?php
    ...
    if($data){  
        echo "<h1 style = 'color:red'>Owner Details</h1>";
        ...
        echo "<h1 style = 'color:red'>Car  Details</h1>";
        ...
        echo "<h2 style = 'color:green; margin:50px 300px '>Kilometers Travelled Previously : ".$data['Kilo'] ."</h2>";
