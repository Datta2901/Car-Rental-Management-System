...
if(isset($_POST['Upload'])){
    ...
    $Fare = $_POST['Fare'];
    $sql = "INSERT INTO booking (OwnerName,OwnerPhone,OwnerEmail,Address,Brand,Model,Colour,Kilo,Seating,Fare,Image) values('$OwnerName','$OwnerPhone','$Address','$Brand','$Model','$Colour','$Kilo','$Seating','$Fare','$file')";
