<?php
    ...
    if($data){  
        ...
        echo "<h style = 'color:green; margin:50px 300px '>COlour : ".$data['Colour']."</h>";
        echo "<h21 style = 'color:green; margin:50px 300px '>Kilometers Travelled Previously : ".$data['Kilo'] ."</h21>";
        echo "<h1 style = 'color:green; margin:50px 300px '>Seating Capacity : ".$data['Seating']."</h1>";
        echo "<h1 style = 'color:green; margin:50px 300px '>Fare (per day) : ".$data['Fare']."</h1>";
