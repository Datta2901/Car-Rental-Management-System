  ...
  <body>
        <div class = "random">
          <center>
              ...
              <p align = "left" class = "some" style = "font-size:30px;align:left">Car Rental Website </p>
              <nav>
                  <a href = "#home" >Home </a>
          ...
          <h1 align = "right" style = "font-size:30px;margin:70ppx">Hello  <?php echo $_SESSION['username'] ?></h1>
