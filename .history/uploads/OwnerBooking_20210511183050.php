...
if(isset($_POST['Upload'])){
    ...
    if(mysqli_query($conn,$sql)){
        echo "<h1 style = 'text-color:green;display:block background-color:green'>Successfully added</h1>";
        echo '<script type = "text/javascript">alert("Car Added Successf")</script>';
