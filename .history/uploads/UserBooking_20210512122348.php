    ...
    <?php
        ...
        while($row = mysqli_fetch_array($query_run)){ 
            ...
            <td>
                ...
                <a href="CarBooking.php? Id= <?php echo $row["Id"];?>"  style = "background-color:green;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;position:relative; left:30px;">Show more</a>
            </td>
            <?php
            $i++;
        }
