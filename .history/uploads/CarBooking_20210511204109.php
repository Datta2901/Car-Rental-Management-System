<?php
    ...
    if($data){  
        ...
        echo "<h1  style = 'color:green;margin:50px 300px '> OwnName  : ".$data['OwnerName']."</h1>";
        echo "<h1 style = 'color:green;margin:50px 300px '>Owner Phone Number : ". $data['OwnerPhone']."</h1>";
        echo "<h1 style = 'color:green;margin:50px 300px '> : ".$data['OwnerEmail']."</h1>";
        echo "<h1 style = 'color:green;margin:50px 300px '>Age : ".$data['Address']."</h1>";
        echo "<h1 style = 'color:green;margin:50px 300px '>Company Name : ".$data['Brand']."</h1>";
