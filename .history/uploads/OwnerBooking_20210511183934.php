...
<html lang="en">
  ...
  <hr class = "Rule">
    <form action = "" method="POST" enctype="multipart/form-data">
        <center>
      ...
      </label          <input  type = "text" name = "Brand" placeholder = "Car Brand" required>
                
            </div>
    
            <label class = "name" >Car Model<span style = "color: red;">&#42;</span>
      </label      <input  type = "text" name = "Model" placeholder = "Model" required>
            
            <div>
                <label class = "name" >Car Colour<span style = "color: red;">&#42;</span>
     </label           <input  type = "text" name = "Colour" placeholder = "colour"required>
                
            </div>
            <div>
                <label class = "name" >Kilo Meters Covered previously<span style = "color: red;</label">&#42;</span>
           ...
           </label     <input  type = "text" name = "Fare" placeholder="Fare per day" required>
