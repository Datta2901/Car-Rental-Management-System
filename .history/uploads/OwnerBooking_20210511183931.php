...
<html lang="en">
  ...
  <hr class = "Rule">
    <form action = "" method="POST" enctype="multipart/form-data">
      ...
      </la          <input  type = "text" name = "Brand" placeholder = "Car Brand" required>
                
            </div>
    
            <label class = "name" >Car Model<span style = "color: red;">&#42;</span>
      </la      <input  type = "text" name = "Model" placeholder = "Model" required>
            
            <div>
                <label class = "name" >Car Colour<span style = "color: red;">&#42;</span>
     </la           <input  type = "text" name = "Colour" placeholder = "colour"required>
                
            </div>
            <div>
                <label class = "name" >Kilo Meters Covered previously<span style = "color: red;</la">&#42;</span>
                <input  type = "text" name = "Kilo" placeholder = "Kilometers  travelled" required>
                
            </div>
            <div>
                <label class = "name" >Seating Capacity<span style = "color: red;">&#42;</span></la
                <input  type = "text" name = "Seating" placeholder = "Seating capacity" required>
                
            </div>
            <div>
                <label class = "name" >Fare<span style = "color: red;">&#42;</span>
           </la     <input  type = "text" name = "Fare" placeholder="Fare per day" required>
                
            </div>
            
            <label for="img">Car image:<span style = "color: red;">&#42;</span>
           </la <input type="file" name="Image" required>
