...
<html lang="en">
  ...
  <hr class = "Rule">
    <form action = "" method="POST" enctype="multipart/form-data">
        <center>
            <div>
                <la class = "name" >Car Brand<span style = "color: red;">&#42;</span>
                <input  type = "text" name = "Brand" placeholder = "Car Brand" required>
                </la>
            </div>
    
            <la class = "name" >Car Model<span style = "color: red;">&#42;</span>
            <input  type = "text" name = "Model" placeholder = "Model" required>
            </la>
            <div>
                <la class = "name" >Car Colour<span style = "color: red;">&#42;</span>
                <input  type = "text" name = "Colour" placeholder = "colour"required>
                </la>
            </div>
            <div>
                <la class = "name" >Kilo Meters Covered previously<span style = "color: red;">&#42;</span>
                <input  type = "text" name = "Kilo" placeholder = "Kilometers  travelled" required>
                </la>
            </div>
            <div>
                <la class = "name" >Seating Capacity<span style = "color: red;">&#42;</span>
                <input  type = "text" name = "Seating" placeholder = "Seating capacity" required>
                </la>
            </div>
            <div>
                <la class = "name" >Fare<span style = "color: red;">&#42;</span>
                <input  type = "text" name = "Fare" placeholder="Fare per day" required>
                </la>
            </div>
            
            <la for="img">Car image:<span style = "color: red;">&#42;</span>
