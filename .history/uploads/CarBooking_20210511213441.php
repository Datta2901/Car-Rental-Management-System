...
<form action ="" method = "POST">
    <marquee scroll><h1 style = "color:blue">Please Enter below details to book  a car for rent.That is  Starting date - when you want to take car,Number of days required. </h1></marquee>
    <center>
    <div>
