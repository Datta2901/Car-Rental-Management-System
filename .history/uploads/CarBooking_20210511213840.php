...
<form action ="" method = "POST">
    ...
    <br>
    <button style = "background-color:Red;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Book Now</button>
    </center>
