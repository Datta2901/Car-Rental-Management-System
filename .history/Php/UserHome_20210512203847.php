...
<html lang="en">
  ...
  <body>
        <p class = "some" style = "font-size:30px;font:bold">Car Rental Website </p>
        <div class = "random">
          <center>
              <nav>
                  <a href = "#home" >Home </a>
        ...
        <?php 
          ...
          echo "<h1 align= right style = 'color:blue;position:relative;top:-60px'> "."Hello ".$username."😀</h1>";
        ?>
        <br>
        <img class = "car"  src = "./../images/Car.jpg" alt = "This is a image2" style = "position:relative;top:-60px">
        <div id = "About" style = "background-color:#3d9996;position:relative;top:-90px">
          <center>
            <h2>About Us</h2>
