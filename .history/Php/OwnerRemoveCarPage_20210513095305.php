<?php
    ...
    while($row = mysqli_fetch_array($query_run)){ 
        ...
        <a href="OwnerRemove? Id= <?php echo $row["Id"];?>"  style = "background-color:red;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;position:relative; left:300px;">Cancel</a>
        <?php
        echo "</td>";
        $i++;
    }
