<?php
    ...
    if(isset($_POST["Submit"])){
        ...
        // $Image = $_POST['Image'];
        $sql = "INSERT INTO cardetails(Name,PhoneNumber,Address,Brand,Model,Colour,Kilo,Seating) values('$Name','$PhoneNumber',' $Address','$Brand','$Model','$Colour','$Kilo','$Seating','$Image')";
        if(mysqli_query($conn,$sql)){
            // echo "Record Added Successfully";
            // header("Location: Display.php");
            echo "<h1> Your Car Successfully added</h1>";
        }
        // }else{
