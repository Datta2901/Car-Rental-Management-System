  ...
  <hr class = "Rule">
    <form action = "" method="POST" enctype="multipart/form-data">
        <center>
            ...
            <a href="OwnerCarBookingHistory.php? Id= <?php echo $row["Id"];?>"  style = "background-color:green;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;position:relative; left:300px;">Show more</a>
            <button name = "Upload" style = "width:fit-content;background-color:green;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Submit</button>
        </center>
    </form>
  </body>
</html>
