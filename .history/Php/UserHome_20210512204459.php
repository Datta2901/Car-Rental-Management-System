...
<html lang="en">
  ...
  <body>
        <p class = "some" style = "font-size:30px;font:bold;position:relative;left:30px;Down:3px">Car Rental Website </p>
        <div class = "random">
          <center>
              <nav>
                  <a href = "#home" >Home </a>
        ...
        <div id = "About" style = "background-color:#3d9996;position:relative">
          <center>
