...
<html lang="en">
  ...
  <body>
        ...
        <?php 
          ...
          echo "<h1 align= right style = 'color:blue;position:relative;bottom:25px'> "."Hello ".$username."😀</h1>";
        ?>
        </div>
        <br>
        <img class = "car"  src = "./../images/Car.jpg" alt = "This is a image2 " style= "position:relative;bottom = -20p">
