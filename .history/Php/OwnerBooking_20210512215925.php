  ...
  <hr class = "Rule">
    <form action = "" method="POST" enctype="multipart/form-data">
        <center>
            ...
            <button name = "Upload" style = "width:fit-content;background-color:oran;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Submit</button>
        </center>
    </form>
  </body>
</html>
