...
<body>
    ...
    <div class = "hometown">
        ...
        <div class = "random" style = "position:relative">
          <center>
              <nav>
                  <a href = "./OwnerHome.php" class = "hometown">Home </a>
                  <div class="dropdown">
                  ...
                  <a href = "./OwnerProfile.php" class = "hometown">My Profile</a>
                  <div class="dropdown">
                  ...
                  <a href = "#About" class = "hometown" >About </a>
                  <a href = "./../Php/ContactUs.html" class = "hometown">Contact Us </a>
